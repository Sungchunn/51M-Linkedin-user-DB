...
// Vanilla JavaScript implementation of moving grid animation
...
document.addEventListener('DOMContentLoaded', () => {
  // Find all elements that should have the squares background
  const containers = document.querySelectorAll('.squares-bg, body');

  containers.forEach(container => {
    // Skip if already initialized
    if (container.dataset.squaresInitialized) return;
